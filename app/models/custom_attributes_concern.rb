module CustomAttributesConcern
  ...
  def get_custom_attribute(attribute_name)
    custom_attribute = custom_attributes.find_by(name: attribute_name)
  ...
  def set_custom_attribute(attribute_name, value)
    custom_attribute = custom_attributes.find_or_initialize_by(name: attribute_name)
    custom_attribute.value = value
    custom_attribute.save
  end

  # Method to delete custom attribute
  def delete_custom_attribute(attribute_name)
    custom_attributes.find_by(name: attribute_name)&.destroy
  end
